...
export interface BlockBlogArchive {
	/** @primaryKey */
	id: string;
	/** @description Tiêu đề hiển thị phía trên khối */
	headline?: string | null;
	/** @description Lọc bài theo tác giả (để trống = tất cả) */
	author_filter?: Team | string | null;
	/** @description Thứ tự sắp xếp bài viết: mới nhất hoặc cũ nhất trước */
	sort_mode?: 'newest' | 'oldest' | null;
	/** @description Lọc bài theo danh mục (để trống = tất cả) */
	categories?: BlockBlogArchiveCategory[] | string[];
}

export interface BlockBlogArchiveCategory {
	/** @primaryKey */
	id: number;
	block_blog_archive_id?: BlockBlogArchive | string | null;
...
export interface Globals {
	...
	url?: string | null;
	logo_on_dark_bg?: DirectusFile | string | null;
	logo_on_light_bg?: DirectusFile | string | null;
...
export interface HelpArticle {
	...
	date_created?: string | null;
	date_updated?: string | null;
	help_collection?: HelpCollection | string | null;
	/** @primaryKey */
	id: string;
...
export interface PageBlock {
	...
	item?: BlockColumn | BlockCta | BlockDivider | BlockFaq | BlockForm | BlockGallery | BlockHero | BlockHtml | BlockLogocloud | BlockQuote | BlockRichtext | BlockStep | BlockTeam | BlockTestimonial | BlockVideo | BlockBlogArchive | BlockWhoIAm | string | null;
	collection?: string | null;
...
export enum CollectionNames {
	block_blog_archive = 'block_blog_archive',
	block_blog_archive_categories = 'block_blog_archive_categories',
