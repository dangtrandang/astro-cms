        ...
        <div className="flex flex-col gap-8 lg:grid lg:grid-cols-[30%_70%] lg:gap-14 lg:items-start">
          <div className="space-y-5 px-4 sm:px-0 lg:space-y-6 lg:flex lg:flex-col lg:justify-center lg:h-full">
            ...
            <div className="flex items-center gap-3">
              ...
              <a href="https://www.youtube.com/@trangthesirian" target="_blank" rel="noopener noreferrer" className="flex h-10 w-10 items-center justify-center rounded-full bg-[#FF0000] text-white transition-all duration-300 hover:scale-110 sm:h-11 sm:w-11" aria-label="YouTube">
